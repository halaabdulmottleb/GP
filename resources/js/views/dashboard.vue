            ...
            <CCardFooter>
                <CRow class="text-center">
                    <CCol md sm="12" class="mb-sm-2 mb-0">
                        ...
                        <CProgress class="progress-xs mt-2"
                                   :precision="1"
                                   color="success"
                                   :value="40" />
                    </CCol>
            ...
            <CCol md="12">
                <CCard>
                    ...
                    <CCardBody>
                        ...
                        <br />
                        <CDataTable class="mb-0 table-outline"
                                    hover
                                    :items="tableItems"
                                    :fields="tableFields"
                                    head-color="light"
                            ...
                            <td slot="avatar" class="text-center" slot-scope="{item}">
                                <div class="c-avatar">
                                    ...
                                    <span class="c-avatar-status"
                                          :class="`bg-${item.avatar.status || 'secondary'}`"></span>
                                </div>
                            </td>
